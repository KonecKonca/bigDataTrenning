...
import kozitski.data.converter.io.reader.TrainCsvReader;
import kozitski.data.converter.scheme.TrainSchemaGenerator;
...
public class TrainAvroWriter {
    ...
    private String hotelCluster;

    @Setter
    private String avroFilePath = IOConstant.TRAIN_WRITE_PATH;
    private TrainSchemaGenerator trainSchemaGenerator;
    private TrainCsvReader csvReader;
    ...
    @Autowired
    public void setCsvReader(TrainCsvReader csvReader) {
        this.csvReader = csvReader;
    }

    public void writeToAvro(){
        Schema schema = trainSchemaGenerator.generateSchema();
        ...
        try (
            ...
            while (csvReader.isHasMore()){
                List<TrainDTO> testDTOS = csvReader.readPart();
